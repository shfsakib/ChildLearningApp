<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="learn-months-name.aspx.cs" Inherits="ChildLearningApp.admin.learn_months_name" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    Month Name:
                    <asp:TextBox ID="txtAnswer" placeholder="January,February etc" autocomplete="off" class="form-control" runat="server"></asp:TextBox>
                </div>
            </div> 
            <div class="row mt-2">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <br />
                    <asp:Button ID="btnAdd" class="btn btn-primary btn-block" OnClick="btnAdd_OnClick" runat="server" Text="Add Month" />
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12 mt-3">
            <div class="table-responsive" style="border: none;">
                <asp:GridView ID="gridMonth" Width="100%" class="table table-hover table-bordered table-striped" AutoGenerateColumns="False" ShowHeader="True" ShowHeaderWhenEmpty="True" EmptyDataText="No Month Found" runat="server">
                    <Columns>
                        ...
                        </asp:TemplateField> <asp:TemplateField HeaderText="Month_Picture">
                            <ItemTemplate>
