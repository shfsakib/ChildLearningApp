...
{
    public partial class add_bangla_consonent : System.Web.UI.Page
    {
        private Function function;
        Random random = new Random();
        public add_bangla_consonent()
        {
        ...
        protected void btnAdd_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool ans = function.Execute($@"INSERT INTO LetterInfo(Letter,LetterAudio,LetterPicture,Word,WordAudio,WordPicture,InTime,LetterType) VALUES(N'{txtalpha.Text}','{letterAudio}','{letterPic}',N'{txtWord.Text}','{wordAudio}','{wordPic}','{date}','Bangla Consonent')");
                if (ans)
                {
                    function.AlertWithRedirect(this, "Added successfully", "/admin/add-bangla-consonent.aspx");
                }
                else
                {
