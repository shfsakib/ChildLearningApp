...
namespace ChildLearningApp.admin
{
    public partial class learn_shape : System.Web.UI.Page
    {
        ...
        private void Load()
        {
            function.LoadGrid(gridShape, $@"SELECT * FROM LearnInfo WHERE Type='Shape' ORDER BY Answer ASC");
        }
        ...
        protected void btnAdd_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool ans = function.Execute($@"INSERT INTO LearnInfo(Answer,Picture,Type) VALUES(N'{txtAnswer.Text}','{pic}','Shape')");
                if (ans)
                {
                    Load();
