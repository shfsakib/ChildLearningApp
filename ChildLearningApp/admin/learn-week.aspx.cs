    ...
    public partial class learn_week : System.Web.UI.Page
    {
        ...
        protected void btnAdd_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool ans = function.Execute($@"INSERT INTO LearnInfo(Answer,Picture,Type) VALUES(N'{txtAnswer.Text}','{pic}','Week')");
                if (ans)
                {
                    Load();
                    function.AlertWithRedirect(this, "Week added successfully", "/admin/learn-Weeks.aspx");
                }
                else
                {
