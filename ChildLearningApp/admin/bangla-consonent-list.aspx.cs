...
{
    public partial class bangla_consonent_list : System.Web.UI.Page
    {
        private Function function;

        public bangla_consonent_list()
        {
        ...
        private void Load()
        {
            function.LoadGrid(gridAlpha, "SELECT * FROM LetterInfo WHERE LetterType='Bangla Consonent' ORDER BY Letter ASC");
        }
        protected void lnkRemove_OnClick(object sender, EventArgs e)
        {
            ...
            {
                function.ShowAlert(this, "Failed to remove bangla vowel");
            }
        }
    }
}