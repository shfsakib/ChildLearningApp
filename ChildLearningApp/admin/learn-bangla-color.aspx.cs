...
namespace ChildLearningApp.admin
{
    public partial class learn_bangla_color : System.Web.UI.Page
    {
        ...
        private void Load()
        {
            function.LoadGrid(gridColor, $@"SELECT * FROM LearnInfo WHERE Type='Bangla Color' ORDER BY Answer ASC");
        }
        ...
        protected void btnAdd_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool ans = function.Execute($@"INSERT INTO LearnInfo(Answer,Picture,Type) VALUES(N'{txtAnswer.Text}','{pic}','Bangla Color')");
                if (ans)
                {
                    Load();
