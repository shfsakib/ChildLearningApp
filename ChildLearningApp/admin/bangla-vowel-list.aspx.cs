...
{
    public partial class bangla_vowel_list : System.Web.UI.Page
    {
        private Function function;

        public bangla_vowel_list()
        {
        ...
        private void Load()
        {
            function.LoadGrid(gridAlpha, "SELECT * FROM LetterInfo WHERE LetterType='Bangla Vowel' ORDER BY Letter ASC");
        }
