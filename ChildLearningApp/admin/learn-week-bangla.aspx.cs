...
{
    public partial class learn_week_bangla : System.Web.UI.Page
    {
        private Function function;
        Random random = new Random();
        public learn_week_bangla()
        {
        ...
        protected void btnAdd_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool ans = function.Execute($@"INSERT INTO LearnInfo(Answer,Picture,Type,Audio) VALUES(N'{txtAnswer.Text}','{pic}','Bangla Week','{letterAudio}')");
                if (ans)
                {
                    Load();
                    function.AlertWithRedirect(this, "Week added successfully", "/admin/learn-Week-bangla.aspx");
                }
                else
                {
