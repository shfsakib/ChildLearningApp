...
{
    public partial class learn_months_name : System.Web.UI.Page
    {
        private Function function;
        Random random = new Random();
        public learn_months_name()
        {
        ...
        protected void btnAdd_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Load();
                    function.AlertWithRedirect(this, "Month added successfully", "/admin/learn-Months-name.aspx");
                }
                else
                {
