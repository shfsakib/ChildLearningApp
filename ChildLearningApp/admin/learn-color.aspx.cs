    ...
    public partial class learn_color : System.Web.UI.Page
    {
        ...
        protected void btnAdd_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool ans = function.Execute($@"INSERT INTO LearnInfo(Answer,Picture,Type,Audio) VALUES('{txtAnswer.Text}','{pic}','Color','{letterAudio}')");
                if (ans)
                {
                    Load();
                    function.AlertWithRedirect(this, "Color added successfully", "/admin/learn-color.aspx");
                }
                else
                {
