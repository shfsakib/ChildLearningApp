...
{
    public partial class learn_bangla_animal : System.Web.UI.Page
    {
        private Function function;
        Random random = new Random();

        public learn_bangla_animal()
        {
        ...
        protected void btnAdd_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool ans = function.Execute($@"INSERT INTO LearnInfo(Answer,Picture,Type) VALUES(N'{txtAnswer.Text}','{pic}','Bangla Animal')");
                if (ans)
                {
                    Load();
                    function.AlertWithRedirect(this, "Animal added successfully", "/admin/learn-bangla-animal.aspx");
                }
                else
                {
