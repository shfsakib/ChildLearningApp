<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="learn-color.aspx.cs" Inherits="ChildLearningApp.admin.learn_color" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    Color Name:
                    <asp:TextBox ID="txtAnswer" placeholder="Red,Blue etc" autocomplete="off" class="form-control" runat="server"></asp:TextBox>
                </div>
            </div> 
            <div class="row mt-2">
                <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-12 mt-3">
            <div class="table-responsive" style="border: none;">
                <asp:GridView ID="gridColor" Width="100%" class="table table-hover table-bordered table-striped" AutoGenerateColumns="False" ShowHeader="True" ShowHeaderWhenEmpty="True" EmptyDataText="No Color Found" runat="server">
                    <Columns>
