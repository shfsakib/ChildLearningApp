<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="learn-week-bangla.aspx.cs" Inherits="ChildLearningApp.admin.learn_week_bangla" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    Week Name:
                    <asp:TextBox ID="txtAnswer" placeholder="শনিবার,রবিবার" autocomplete="off" class="form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-12">
            ...
            <div class="table-responsive" style="border: none;">
                <asp:GridView ID="gridWeek" Width="100%" class="table table-hover table-bordered table-striped" AutoGenerateColumns="False" ShowHeader="True" ShowHeaderWhenEmpty="True" EmptyDataText="No Week Found" runat="server">
                    <Columns>
                        ...
                        </asp:TemplateField> <asp:TemplateField HeaderText="Week_Picture">
                            <ItemTemplate>
