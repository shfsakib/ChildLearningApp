<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="add-bangla-vowel.aspx.cs" Inherits="ChildLearningApp.admin.add_bangla_vowel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card-title">
        <h3>Add Bangla Vowel</h3>
    </div>
    <hr />
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    Letter:
                    <asp:TextBox ID="txtalpha" placeholder="অ,আ,ই" autocomplete="off" class="form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-12">
            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    Word with Letter:
                    <asp:TextBox ID="txtWord" placeholder="অজগর,আম ইত্যাদি" autocomplete="off" class="form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <br />
                    <asp:Button ID="btnAdd" class="btn btn-primary btn-block" OnClick="btnAdd_OnClick" runat="server" Text="Add Bangla Vowel" />
                </div>
            </div>
        </div>
    </div>
