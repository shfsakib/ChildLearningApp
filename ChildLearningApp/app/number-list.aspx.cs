...
namespace ChildLearningApp.app
{
    public partial class number_list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                LoadData();
                audioWord.Src = function.IsExist($@"SELECT TOP 1 LetterAudio FROM LetterInfo WHERE LetterType=N'Number' ORDER BY Word ASC");
        ...
        protected void btnLetter_OnClick(object sender, EventArgs e)
        {
            ...
            HiddenField letter = (HiddenField)linkButton.Parent.FindControl("HiddenField2");
             lblLetter.Text = function.IsExist($@"SELECT TOP 1 Letter FROM LetterInfo WHERE LetterType=N'Number' AND Letter=N'{letter.Value}' ORDER BY LetterId ASC");
