<%@ Page Title="" Language="C#" MasterPageFile="~/app/app.Master" AutoEventWireup="true" CodeBehind="bangla-vowel.aspx.cs" Inherits="ChildLearningApp.app.bangla_vowel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-12 d-flex mt-2 mb-2 text-center">
        ...
        <asp:linkbutton id="lnkMic" cssclass="btn" style="color: white !important;" onclick="lnkMic_Click" runat="server"><i class="fas fa-volume-up fa-lg mt-3"></i></asp:linkbutton>
