...
{
    public partial class find_number : System.Web.UI.Page
    {
        ...
        private void Load()
        {
            findId.Value = function.IsExist($@"SELECT TOP 1 FindId FROM FindAnswer WHERE LangType='English' AND QuestionType='Number' ORDER BY NEWID()");
