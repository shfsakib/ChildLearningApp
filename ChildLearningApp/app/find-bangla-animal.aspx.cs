...
{
    public partial class find_bangla_animal : System.Web.UI.Page
    {
        private Function function;

        public find_bangla_animal()
        {
        ...
        private void Load()
        {
            findId.Value = function.IsExist($@"SELECT TOP 1 FindId FROM FindAnswer WHERE LangType=N'Bangla' AND QuestionType=N'Animal' ORDER BY NEWID()");
